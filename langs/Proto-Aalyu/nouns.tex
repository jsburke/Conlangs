...
There a handful of general use particles and patterns in \langname. With the exception of a couple, they always join at the end on the noun stem, and several may stack on top of each other.
  ...
  \begin{wrapfigure}{l}{0.45\textwidth}
    \begin{tabular}{|l|l|l|}
      \hline
      Number & Cardinal & Ordinal \\ \hline \hline
      1      &          &         \\
      2      &          &         \\
      3      &          &         \\
      4      &          &         \\
      ...
      8      &          &         \\
      9      &          &         \\
      10     & nyiwa    & nyiwa\ordnum        \\
      100    &          &         \\ \hline
    \end{tabular}
  \end{wrapfigure}
  \langname features a base 10 number system with a subbase of 5. The number for 5 appears to derive be related to the word for hand, and the number for 10 appears to be related to the word for "to complete." Given the age of the language, there is no word for zero, terms like "nothing," "none," or "absent" being used instead. It is also difficult to reconstruct numbers that exceed the value of ten thousand; it may have existed and seen usage, but such numbers cannot be convincingly supported. The basic numbers are presented in the table.
